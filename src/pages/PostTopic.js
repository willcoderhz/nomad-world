...
const PostTopic = () => {
  ...
  return (
    <div className="mt-16 lg:mr-64 container mx-auto px-4 py-16 lg:px-64 min-h-screen">
      <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">发布话题</h1>
      ...
      <div className="bg-white border border-gray-300 p-6 rounded-lg shadow hover:shadow-md transition-shadow duration-300">
        ...
        <div className="flex justify-center"> {/* 添加flex容器以居中按钮 */}
          <button 
            ...
            className="mt-6 bg-blue-200 hover:bg-blue-300 text-blue-800 font-bold py-2 px-4 rounded inline-flex items-center transition duration-300"
          >
            提交
          </button>
        </div>
